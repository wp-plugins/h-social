...
$apiConfig = array(
  ...
  //  'application_name' => 'login with google',
    'application_name' => $google_client['app_name'],

    // OAuth2 Settings, you can get these keys at https://code.google.com/apis/console
    'oauth2_client_id' => $google_client['client_id'],
    'oauth2_client_secret' => $google_client['client_secret'],
    'oauth2_redirect_uri' => $google_client['client_redirect_uri'],
    // 'oauth2_client_id' => '892459264289-fg614sv6s48v8gscgdtpgu9m0g386h24.apps.googleusercontent.com',
    // 'oauth2_client_secret' => 'CPwHOwEt74DrAb3nCT7Ojb0N',
    // 'oauth2_redirect_uri' => 'http://localhost/wplogin/wp-login.php',
    ...
    'site_name' => 'http://localhost:8080/gplus',
